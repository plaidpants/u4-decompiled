...
/*C_794D*/w_SameExit()
{
	u4_puts(/*D_239E*/&AVATAR[0x11651] /* "All must use same exit!\n" */);
	sound(1,0);
}
...
C_7B89()
{
	u4_puts(/*D_23B7*/&AVATAR[0xFC17] /* "North\n" */);
...
C_7BAF()
{
	u4_puts(/*D_23BE*/&AVATAR[0xFC38] /* "South\n" */);
	C_7AE3(activeChara, Combat._charaX[activeChara], Combat._charaY[activeChara] + 1);
}
...
C_7BD5()
{
	u4_puts(/*D_23C5*/&AVATAR[0xFC75] /* "East\n" */);
...
C_7BFD()
{
	u4_puts(/*D_23CB*/&AVATAR[0xFC57] /* "West\n" */);
	C_7AE3(activeChara, Combat._charaX[activeChara] - 1, Combat._charaY[activeChara]);
}
