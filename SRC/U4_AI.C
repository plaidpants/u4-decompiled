...
int bp04;
{
	...
	u4_puts(/*D_29CA*/&AVATAR[0x11C75] /* " is Killed!\n" */);
...
int bp04;
{
	...
	switch(hit_tile) {
		case TIL_44:
			u4_puts(/*D_29D7*/&AVATAR[0x11C82] /* "Poisoned!\n" */);
			C_9764(si);
			if(U4_RND1(1) || Party.chara[si]._stat != 'G')
				u4_puts(/*D_29E2*/&AVATAR[0x11C8D] /* "Failed.\n" */);
			else
				Party.chara[si]._stat = 'P';
		break;
		case TIL_45:
			u4_puts(/*D_29EB*/&AVATAR[0x11C96] /* "Electrified!\n" */);
			C_96B9(si, bp08);
		break;
		case TIL_46:
			u4_puts(/*D_29F9*/&AVATAR[0x11CA4] /* "Fiery Hit!\n" */);
			C_96B9(si, bp08);
		break;
		case TIL_47:
			u4_puts(/*D_2A05*/&AVATAR[0x11CB0] /* "Slept!\n" */);
			C_9764(si);
			if(U4_RND1(1) || Party.chara[si]._stat != 'G')
				u4_puts(/*D_2A0D*/&AVATAR[0x11C8D] /* "Failed.\n" */);
			else {
		...
		break;
		case TIL_4C:
			u4_puts(/*D_2A16*/&AVATAR[0x11CC1] /* "Lava Hit!\n" */);
			C_96B9(si, bp08);
		break;
		case TIL_4E:
			u4_puts(/*D_2A21*/&AVATAR[0x11CCC] /* "Magical Hit!\n" */);
			C_96B9(si, bp08);
		break;
		default:
			u4_puts(/*D_2A2F*/&AVATAR[0x11CAA] /* "Hit!\n" */);
			C_96B9(si, bp08);
	}
	hit_tile = 0;
	dspl_Stats();
...
int bp04;
{
	...
	u4_puts(/*D_2A35*/&AVATAR[0x11CE0] /* " Flees!\n" */);
